            ...
            <Nav className="mr-auto">
              ...
              <Nav.Link> 
                ...
                <div style={{backgroundColor: 'rgb(233, 233, 233)' , margin:'0px 0px 10px 0px' }}>
                   ...
                   <p className="navitemN" onClick={()=>{this.setState({nfdiv1:true , nfdiv2:false , nfdiv3:false , nfdiv4:false  , nfdiv5:false})}} >JOBS</p>
                   <p className="navitemN" onClick={()=>{this.setState({nfdiv1:false , nfdiv2:true , nfdiv3:false , nfdiv4:false , nfdiv5:false})}}>INTERNSHIPS</p> 
                   <p className="navitemN" onClick={()=>{this.setState({nfdiv1:false , nfdiv2:false , nfdiv3:true , nfdiv4:false , nfdiv5:false})}}>SEMINARS</p>
                   <p className="navitemN" onClick={()=>{{this.setState({nfdiv1:false , nfdiv2:false , nfdiv3:false , nfdiv4:true , nfdiv5:false})} this.showSkills() }}>SCHOLARSHIPS</p>
                   <p className="navitemN" onClick={()=>{this.setState({nfdiv1:false , nfdiv2:false , nfdiv3:false , nfdiv4:false , nfdiv5:true})}}>OTHERS</p>
                   </div>
                </div>
...
export default StudentViewNewsFeed;